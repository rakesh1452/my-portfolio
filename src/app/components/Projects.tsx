      ...
      {projects.map((project, index) => (
        <div className="w-full lg:w-1/3 sm:w-1/2 p-4" key={index}>
          <div className="relative group h-[400px] rounded-lg overflow-hidden">
            ...
            {/* Overlay Content - FULL COVER */}
            <div className="absolute inset-0 bg-gray-200 bg-opacity-95 text-black p-6 flex flex-col justify-center items-center text-center transform translate-y-full group-hover:translate-y-0 transition-all duration-500 ease-in-out">
